                                                    ...
                                                    // } 
                                                     ...
                                                     if (($product[0]['product_count'] === "Y") || ($product[0]['combo_product'] === "Y")) {
                                                            ...
                                                            for ($i = 0; $i < $jml; $i++) {
                                                                ...
                                                                $ref_id = $order_id_reference[$i] ?? null; // Validasi ref_id untuk setiap pesanan
                                                        
                                                                // Jika ref_id tidak ada, lewati iterasi
                                                                if (!$ref_id) {
                                                                    continue;
                                                                }
                                                                ...
                                                                log_message('info', "Response dari API untuk Ref ID {$ref_id}: " . print_r($result, true));
