			                    ...
			                    <div class="section">
			                        ...
			                        <div class="table-responsive">
			                        	<table class="table table-white table-striped mb-0">
			                        		<tr>
			                        			<th>No Upgrade Member</th>
			                        			<th>Metode</th>
			                        			<th>Nominal</th>
			                        			<th>Status</th>
			                        			<th>Tanggal</th>
			                        		</tr>
			                        		<?php foreach ($register as $loop): ?>
			                        		<tr>
			                        			<td>
			                        				<a href="<?= base_url(); ?>/user/upgrademembership/<?= $loop['register_id']; ?>"><b><?= $loop['register_id']; ?></b></a>
			                        			</td>
			                        			<td><?= $loop['method']; ?></td>
			                        		...
			                        		<tr>
			                        			<td align="center" colspan="5">Tidak ada riwayat upgrade member</td>
			                        		</tr>
			                        		<?php endif ?>
			                        	</table>
			                        </div>
