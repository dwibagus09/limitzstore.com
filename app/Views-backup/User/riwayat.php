			...
			<div class="content" style="min-height: 580px;">
			    <div class="container">
			        <div class="row">
			            ...
			            <div class="col-lg-9">
			            	<div class="pb-4">
			                    <h5 id="riwayat">Riwayat</h5>
			                    <span class="strip-primary"></span>
			                </div>
			                <div class="pb-3">
			                    <div class="section" id="cardRiwayat">
			                        <div class="card-body">
			                        	<div class="row">
			                        		<div class="col-md-6">
			                        			<form action="" method="POST">
					                        		<div class="input-group">
					                        			<input type="text" class="form-control" autocomplete="off" placeholder="Pencarian" style="border: 1px solid #ced4da;">
