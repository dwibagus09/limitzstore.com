									...
									<div class="card">
										<div class="card-body">
											...
											<?= csrf_field(); ?> 
												...
												<div class="mb-3 row">
													<label class="col-form-label col-md-4">Rate Modal</label>
													<div class="col-md-8">
														<input type="text" class="form-control" autocomplete="off" name="rate_modal">
													</div>
												</div>
												<div class="mb-3 row">
													<label class="col-form-label col-md-4">Rate Publik</label>
													<div class="col-md-8">
														<input type="text" class="form-control" autocomplete="off" name="rate">
													</div>
												</div>
												<div class="mb-3 row">
													<label class="col-form-label col-md-4">Rate Silver</label>
													<div class="col-md-8">
														<input type="text" class="form-control" autocomplete="off" name="rate_silver">
													</div>
												</div>
												<div class="mb-3 row">
													<label class="col-form-label col-md-4">Rate Gold</label>
													<div class="col-md-8">
														<input type="text" class="form-control" autocomplete="off" name="rate_gold">
													</div>
												</div>
												<div class="mb-3 row">
													<label class="col-form-label col-md-4">Rate Bisnis</label>
													<div class="col-md-8">
