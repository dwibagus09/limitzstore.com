				...
				<div class="card-body">
                    ...
                    <?= csrf_field(); ?> 
						<div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" autocomplete="off" name="target">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="img" cols="30" rows="4" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" autocomplete="off" name="sparator">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="table-responsive">
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" autocomplete="off" name="error">
                            </div>
                        </div>
