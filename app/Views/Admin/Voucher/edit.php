							...
							<div class="card-body">
								...
								<?= csrf_field(); ?> 
									...
									<div class="mb-3 row">
										...
										<div class="col-md-8">
											<select name="diskon_type" class="form-control">
												<option value="Flat" <?= $voucher['diskon_type'] == 'Flat' ? 'selected' : ''; ?>>Flat</option>
												<option value="Percent" <?= $voucher['diskon_type'] == 'Percent' ? 'selected' : ''; ?>>Persen</option>
											</select>
										</div>
									</div>
									<div class="mb-3 row">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" autocomplete="off" name="diskon" value="<?= $voucher['diskon']; ?>">
										</div>
									</div>
									<div class="mb-3 row">
										<label class="col-form-label col-md-4">Max. Potongan</label>
										<div class="col-md-8">
											<input type="number" class="form-control" autocomplete="off" name="max" value="<?= $voucher['max']; ?>">
									...
									<div class="mb-3 row">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" autocomplete="off" name="title" value="<?= $voucher['title']; ?>">
										</div>
									</div>
									<div class="mb-3 row">
										<label class="col-form-label col-md-4">Konten</label>
										<div class="col-md-8">
										    <textarea name="content"><?= $voucher['content']; ?></textarea>
										</div>
									</div>
									<div class="mb-3 row">
										<label class="col-form-label col-md-4">Limit</label>
										<div class="col-md-8">
											<input type="number" class="form-control" autocomplete="off" name="stok" value="<?= $voucher['stok']; ?>">
										</div>
									</div>
									<div class="mb-3 row">
										...
										<div class="col-md-8">
											<select name="private" class="form-control">
												<option value="Y" <?= $voucher['private'] == 'Y' ? 'selected' : ''; ?>>Ya</option>
												<option value="N" <?= $voucher['private'] == 'N' ? 'selected' : ''; ?>>Tidak</option>
											</select>
										</div>
									</div>
									<div class="mb-3 row">
										...
										<div class="col-md-8">
										    <?php 
										    $llist = explode(',', $voucher['level']);
										    foreach (['Guest', 'Member', 'Silver', 'Gold', 'Bisnis'] as $l): ?>
										    <div class="form-check">
										        <input class="form-check-input" type="checkbox" id="cl-<?= strtolower($l); ?>" name="level[]" value="<?= $l; ?>" <?= in_array($l, $llist) ? 'checked' : ''; ?>>
