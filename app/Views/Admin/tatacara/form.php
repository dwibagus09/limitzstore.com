							...
							<div class="card-body">
								...
								<?= csrf_field(); ?> 
									<div class="mb-3 row">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" autocomplete="off" name="nama" value="<?=isset($edit["nama"]) ? set_value("nama", $edit["nama"]): set_value("nama"); ?>">
										</div>
									</div>
                                    <div class="mb-3 row">
										<label class="col-form-label col-md-4">Slug</label>
										<div class="col-md-8">
											<input type="text" class="form-control" autocomplete="off" name="slug" value="<?=isset($edit["slug"]) ? set_value("slug", $edit["slug"]): set_value("slug"); ?>">
										</div>
									</div>
