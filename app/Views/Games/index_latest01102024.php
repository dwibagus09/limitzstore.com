	                ...
	                <?php if (count($target) == 1 && $target[0]['target'] != 'default'): ?>
	                    <div class="card mt-6">
	                        <div class="card-body eniv-card">
	                            ...
	                            <p class="text-muted fs-12 mb-3"><?= $target[0]['description']; ?></p>
                                <div id="contact_person">
                                    <p class="fw-600 mb-3">No WhatsApp</p>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        <div class="input-group mb-2">
                                            <span class="input-group-text left"><i class="fa fa-envelope fs-18"></i></span>
                                            <input type="email" class="form-control" placeholder="Masukkan Email (opsional)" autocomplete="off" name="email">
                                        </div>
                                        <small class="text-muted">Bukti pembayaran atas pembelianmu akan kami kirimkan ke No WhatsApp atau Email.</small>
                                    </div>
                                </div>
	                        </div>
	                    </div>
...
<div class="error_message">
    ...
    <p>
    <img src="<?= base_url(); ?>/assets/images/err_icon.jpg" alt=""> &ensp;<span></span>&ensp;&ensp;
    </p>
    </div>
</div>
<?php $this->endSection(); ?>
...
function select_product(id) {
	...
	$('#decrease').off().on('click', function() {
        ...
        updateTotalCount(id, $('#jumlah').val());
    });
...
function process_order() {
    ...
    var wa = $("input[name=wa_phoneCode]").val() + $("input[name=wa]").val();;
    ...
    if (product == "" || product == " " || product == "0" || product == 0) {
        ...
        //Swal.fire('Gagal', 'Invalid Action', 'error');
        showNotifications('Invalid Action');
    }
}
