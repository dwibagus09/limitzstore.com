        ...
        <div class="eniv-body">
            ...
            <div class="row justify-content-center">
            	...
            	<div class="col-md-8">
                    ...
                    <div class="eniv-product-area" style="padding-top:0px !important;margin-top:0px !important;">
                    	...
                    	<div class="mobile-only">
	                    	<div class="menu-category-product d-flex flex-row">
	                    		...
	                    		if($k == 0){ $class_menu_activated="activated-category-menu"; }
	                    		?>
	                    		<div class="col-3 p-2">
		                    		<div id="cat-product-<?= $k; ?>" class="menu-category-product-item <?= $class_menu_activated; ?> text-center text-wrap p-1" onclick="show_category_product('<?= $k; ?>','<?= count($product); ?>');">
			                            <br />
                    	...
                    	<div class="desktop-only" style="overflow-x: scroll; white-space: nowrap; overflow-y: hidden;">
	                    	<div class="menu-category-product d-flex flex-row">
	                    		...
	                    		?>
	                    		<div class="col-3 p-2">
		                    		<div id="cat-product-mobile-<?= $k; ?>" class="menu-category-product-item <?= $class_menu_activated; ?> text-center text-wrap p-1" onclick="show_category_product('<?= $k; ?>','<?= count($product); ?>');">
			                            <br />
                        ...
                        <?php foreach ($product as $k => $product_loop): ?>
                        <div class="row mt-2" id="row-cat-product-<?= $k; ?>">
                            <!--<div class="col-md-12">
...
$(document).ready(function(){
    $("#feedback").hide();
    var num_of_category = <?= count($product); ?>;
    for (var i = 1; i <= num_of_category; i++) {
    	$("#row-cat-product-"+i).hide();
    }
});
...
function show_category_product(no, num_of_category) {
    ...
    for (var i = 0; i <= num_of_category; i++) {
    	$("#row-cat-product-"+i).hide();
    	$("#cat-product-" + i).removeClass('activated-category-menu');
    	$("#cat-product-mobile-" + i).removeClass('activated-category-menu');
    	if(i == no){
			$("#row-cat-product-"+i).show();
			$("#cat-product-" + i).addClass('activated-category-menu');
			$("#cat-product-mobile-" + i).addClass('activated-category-menu');
    	}
    }
}
</script>
