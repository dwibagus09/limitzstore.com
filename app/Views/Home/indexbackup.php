           ...
           <div class="eniv-content">
               <div class="container">
                   <div class="eniv-body">
                       <div class="swiper swiper-carousel">
                           <div class="swiper-wrapper">
                               ...
                               <div class="swiper-slide">
                                   <img src="<?= $loop['image']; ?>" alt="" width="100%" class="rounded">
                               </div>
                               <?php endforeach ?>
                           </div>
                           ...
                           <?php if($config['value'] == 1) { ?>
                               <div class="games-category">
                                   ...
                                   <?php foreach ($populer as $loop): ?>
                                       <div class="col-md-4 col-6 eniv-col blackwhite" style="margin-bottom:50px;">
                                           <a class="games-item" href="<?= base_url(); ?>/games/<?= $loop['slug']; ?>" data-games="<?= $loop['id']; ?>" style="background-image: url(<?= $loop['image']; ?>);height:150px;border-radius: 10px;background-size: cover;">
                                               <div style="position:relative;top:100px;border-radius:0 0 10px 10px;;padding:10px;background:var(--warna_2);">
                                               <h6 class="text-mobile"><?= $loop['games']; ?></h6>
                                               <span class="text-mobile"><?= $loop['subs_title']; ?></span>
                                               </div>
                                           </a>
                                       </div>
                                       <?php endforeach; ?>
                               ...
                               <div class="games-category">
                                   ...
                                   <?php if (count($category['games']) == 6): ?>
                                       <div class="text-center">
                                           <button class="btn btn-sm btn-primary mb-4 show-more" data-category="<?= $category['id']; ?>" data-offset="6" style="background:transparent !important;color:var(--warna_3) !important;font-size:17px;margin-top:10px;">Show more</button>
                                       </div>
                                   <?php endif;?>
                               </div>
                           </div>
                       ...
                       <div class="text-center mb-5">
                           <h6 class="fs-20 fw-500">Layanan <?= $web['title']; ?></h6>
                           <p class="mw-500 m-auto"><?= $web['title']; ?> memiliki provider game berkualitas yang terintegrasi dengan <span class="text-primary">lebih dari 50 game dengan total produk +1000 produk</span></p>
                       </div>
                           ...
                           <div class="col-md-10">
                               <div class="row">
                                   ...
                                   <div class="col-md-2 col-4">
                                       <img src="<?= base_url(); ?>/assets/images/games/home/<?= $i; ?>.png" alt="" class="w-100 mb-5">
                                   </div>
                                   <?php endfor; ?>
                               </div>
                           </div>
                   ...
                   $('.show-more').click(function(){
                       ...
                       var dataOffset = $(this).data('offset');
                        ...
                        $.ajax({
                           ...
                           data: { id: category, offset: dataOffset },
                           success: function(response){
                               if(response.data.length == 0) {
                                   $('.show-more[data-category="' + category + '"]').remove();
                               } else {
