...
<div class="left-menu">
    <div class="content-logo">
        <div class="logo">
            ...
            <span>Otomax Documentation</span>
        </div>
    ...
    <div class="content-menu">
        <ul>
            ...
            <li class="scroll-to-link" data-target="content-check-nick">
                <a>Check Nick</a>
            </li>
        </ul>
    </div>
...
<div class="content-page">
    ...
    <div class="content">
        <div class="overflow-hidden content-section" id="content-get-started">
            <h1>Get started</h1>
            <pre>
    API Endpoint : https://api.dimunaz-pedia.id/v2/otomax?apikey=YOUR-APIKEY<br/>
            ...
            <p>
                ...
                <strong>IPv4</strong> 103.147.154.193<br />
                <strong>IPv6</strong> 2001:df7:5300:2::90<br /><br />
        ...
        <div class="overflow-hidden content-section" id="content-get-account">
            ...
            <p>
                Api Endpoint :<br>
                <code class="higlighted break-word">https://api.dimunaz-pedia.id/v2/account_otomax?apikey=YOUR-APIKEY</code>
            </p>
            <br>
            <pre><code class="json">
Result example :

{
    ...
    "data": {
        ...
        <div class="overflow-hidden content-section" id="content-get-saldo">
            ...
            <p>
                Api Endpoint :<br>
                <code class="higlighted break-word">https://api.dimunaz-pedia.id/v2/balance_otomax?apikey=YOUR-APIKEY</code>
            </p>
            <br>
            <pre><code class="json">
Result example :

{
    ...
    "data": {
        ...
        <div class="overflow-hidden content-section" id="content-get-product">
            ...
            <p>
                Api Endpoint :<br><br>
                <code class="higlighted break-word">https://api.dimunaz-pedia.id/v2/product_otomax?apikey=YOUR-APIKEY</code><br/><br/>
...

{
    ...
    "data": [
        ...
        <div class="overflow-hidden content-section" id="content-get-order">
            ...
            <p>
                Api Endpoint :<br>
                <code class="higlighted break-word">https://api.dimunaz-pedia.id/v2/order_otomax?apikey=YOUR-APIKEY&sku_product=MLBB113&product=110.10&user_id=1231231&order_id=INVTEST01</code>
            </p>
            <br>
            <pre><code class="json">
Result example :

{
    ...
    "data": Order ID Anda
        ...
        <div class="overflow-hidden content-section" id="content-check-transaksi">
            ...
            <p>
                Api Endpoint :<br>
                <code class="higlighted break-word">https://api.dimunaz-pedia.id/v2/status_otomax?apikey=YOUR-APIKEY&order_id=YOUR-ORDER-ID</code>
            </p>
            <br>
            <pre><code class="json">
Result example :

{
    ...
    "data": {
        ...
        <div class="overflow-hidden content-section" id="content-check-nick">
            <h2>Check Nick</h2>
            <pre><code class="bash">
                </code></pre>
            <p>
                Api Endpoint :<br>
                <code class="higlighted break-word">https://api.dimunaz-pedia.id/v2/check_nick?apikey=YOUR-APIKEY&check_code=mobilelegends&user_id=YOUR-USER-ID&zone_id=4429155602037
                </code>
            </p>
            <br>
            <pre><code class="json">
