									...
									<?= csrf_field(); ?> 
		                        		...
		                        		<div class="mb-3">
		                        			...
		                        			<select class="form-control" name="level">
		                        			    ...
		                        			    <option value="<?= $loop['id']; ?>"><?= $loop['level']; ?> Rp <?= number_format(floatval($loop['price']), 0, ",", ".");?></option>
		                        			    <?php endforeach; ?>
		                        			</select>
		                        		</div>
		                        		<div class="mb-3">
		                        		...
		                        		<div class="text-end">
		                        			...
		                        			<button class="btn btn-primary btn-auth" type="submit" name="tombol" value="submit">Upgrade Akun</button>
		                        		</div>
		                        	</form>
        						</div>
        					</div>
